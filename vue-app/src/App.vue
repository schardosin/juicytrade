<template>
  <div class="app-container">
    ...
    <!-- Options Chain Info -->
    <Card v-if="optionsChain.length > 0" class="options-info-card">
      <template #content>
        <Message severity="info" :closable="false">
          Fetched {{ optionsChain.length }} option contracts for
          {{ symbol }} expiring {{ formatDate(expiry) }}.
        </Message>
      </template>
    </Card>
...
import { generateButterflyPayoff, createChartConfig } from "./utils/chartUtils";
